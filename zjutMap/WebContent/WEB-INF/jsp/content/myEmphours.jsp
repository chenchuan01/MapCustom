...
<div class="span12">
	<div class="span12 pull-right">
		<form id="search" class="form-inline pull-right" action="empHour/empHourPage.do">
		  <input type="hidden" class="input-middle" name="empno" value="${sysuser.empno }">
		  ...
		  <button type="button" class="btn btn-info" onclick="page(1)"
	...
	<table class="table table-bordered" style="text-align: center; background: #fff;">
		...
		<thead>
			<tr>
				<th>#</th><th>日期</th><th>应出勤工时</th><th>已出勤工时</th><th>未出勤工时</th><th>状态</th>
			</tr>
		</thead>
